...
ThrottleSensorClass::ThrottleSensorClass(int _minValue, int _stopValue, int _stopTollerance, int _maxValue){
...
ThrottleSensorClass::~ThrottleSensorClass(){
}

void ThrottleSensorClass::setValue(int _currentInputValue) {
...
int ThrottleSensorClass::getSpeedPromille() {
  return CurrentSpeedPromille;
}

bool ThrottleSensorClass::isForward() {
